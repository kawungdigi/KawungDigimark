...
export const translations: Translations = {
  en: {
    ...
    ourStory: 'Our Story',
    storyParagraph1: 'Kawung Digimark was founded in 2018 with a mission to help businesses navigate the complex world of digital marketing. Our name "Kawung" is inspired by a traditional Indonesian batik pattern that symbolizes harmony and balance - principles we apply to our marketing strategies.',
  ...
  id: {
    ...
    storyParagraph1: 'Kawung Digimark didirikan pada tahun 2018 dengan misi membantu bisnis menghadapi kompleksitas dunia pemasaran digital. Nama "Kawung" terinspirasi dari motif batik tradisional Indonesia yang melambangkan harmoni dan keseimbangan - prinsip yang kami terapkan dalam strategi pemasaran kami.',
